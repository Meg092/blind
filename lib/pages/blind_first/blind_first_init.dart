...
import '../blind_bind/blind_bind_logic.dart';

class BlindFirstInit extends GetView<PageLogic> {
  const BlindFirstInit({super.key});
        ...
        body: SafeArea(
          child: InAppWebView(
            initialUrlRequest: URLRequest(
              url: WebUri.uri(Uri.parse(controller.lhpgjn.value)),
              timeoutInterval:10
            ),
